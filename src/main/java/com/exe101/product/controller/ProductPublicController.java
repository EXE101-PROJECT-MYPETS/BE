...
public class ProductPublicController {
    ...
    public ResponseEntity<ScrollResponse<ProductDTO>> getAllMobile(
        ...
        return ResponseEntity.ok(productPublicService.getAllForMobile(keyword, active, cursor, size));
    }
    ...
    public ResponseEntity<ScrollResponse<ProductDTO>> getByShop(
        ...
        return ResponseEntity.ok(productPublicService.getAllForMobileByShop(shopId, keyword, active, cursor, size));
    }
